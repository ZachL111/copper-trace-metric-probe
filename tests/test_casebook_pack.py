"""Regression checks for the copper-trace-metric-probe casebook."""
...
from casebook.harness import assert_expected, copper_trace_metric_probe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(copper_trace_metric_probe_summary(), assert_expected())
